$(document).ready(function(){
   ...
   var accountSettingsBut = $('#accountSettings');
   accountSettingsBut.addClass('clickable');
   accountSettingsBut.click(
   		function() {
  ...
  $("#classes").hoverIntent( intentConfig )
   
   function inputExpand() {
     $('#classes').animate({width: '400px'});
   }

   function inputRetract() {
     $('#classes').animate({width: '150px'})
   }
   
   var copyDataBut = $('#dataCopy');
   copyDataBut.addClass('clickable');
   copyDataBut.click(
   		function() {
   ...
   var searchBut = $("#searchCG");
   searchBut.addClass("clickable");
   searchBut.click(
		function() {
			if(!$('#distance').val() || !$('#location').val()) {
				$('#distance').tooltip('show');
				$('#location').tooltip('show');
				searchBut.preventDefault();
			}
			$('#classesBlock').slideUp('slow');
			$('#profileBlock').slideUp('slow');
			$('.carousel-inner').empty();
